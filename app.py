...
def find_relevant_verses(query, k=3):
    ...
    embedding = genai.embed_content(model="models/gemini-embedding-001", content=query)["embedding"]
...
def ask():
    ...
    Knowledge base to reference (relevant slokas from Bhagavad Gita): {results}
    IMPORTANT:
    ...
    - End with a divine closing statement like: "I, Krishna, am always with you. Be strong."
    """
